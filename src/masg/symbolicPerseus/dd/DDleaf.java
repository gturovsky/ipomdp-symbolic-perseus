...
public class DDleaf extends DD {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8588546117851010213L;
	...
	public static DD myNew(double val) {
		...
		WeakReference<Object> storedLeaf = (WeakReference<Object>) Global.leafHashtable.get(leaf);
		if (storedLeaf != null)
	...
	public void printDotDD(PrintStream ps, String name) {
		ps.println("{ rank = same; node [shape=box, style=filled, color=goldenrod];\""
				+ name + "\" [label=\"" + Double.toString(val) + "\"];}");
	}
