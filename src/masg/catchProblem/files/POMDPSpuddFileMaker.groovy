...
class POMDPSpuddFileMaker extends AbstractSpuddFileMaker {
	private int width, height
	public POMDPSpuddFileMaker(int w, int h) {
		width = w
		height = h
	}
	...
	public void makeSpuddFile(String spuddFileName) {
		double totalStates = Math.pow((double)width*(double)height,2.0f)
		...
		spudder.initBelief()
				...
				.hasValue { args ->
					...
					if(args["apos1"]==args["wpos"])
						...
						return String.format("%.20f",1.0f/(totalStates-25))
				}
